...
[![x-cmd/install — yai Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/yai.svg?lang=zh)](https://x-cmd.com/install/yai)
...
合计: **2,364** 行代码（覆盖前 5 种语言、共 **44** 个文件）。
...
- **上游仓库**: <https://github.com/ekkinox/yai>
- **官网**: <https://ekkinox.github.io/yai>
- **许可证**: MIT
...
- **Star**: 869 · **Fork**: 61 · **开放 issue**: 30 · **贡献者**: 1

## 累计统计

- **发布数**: 6 · **已合并 PR**: 61 · **开放 PR**: 11 · **已关闭 issue**: 13 · **开放 issue**: 17 · **提交数**: 296
...
yai 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `yai` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/yai.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T05:03:41Z._
